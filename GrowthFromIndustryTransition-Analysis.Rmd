...
```{r}
###  --- EAST ASIA & PACIFIC: PREDICTION MODELS FOR GROWTH FROM INDUSTRY TRANSITIONS ---  ###
...
```{r}
###  --- EUROPE AND CENTRAL ASIA: PREDICTION MODELS FOR GROWTH FROM INDUSTRY TRANSITIONS ---  ###
...
```{r}
###  ---LATIN AMERICA & CARRIBEAN: PREDICTION MODELS FOR GROWTH FROM INDUSTRY TRANSITIONS ---  ###
...
```{r}
###  --- MIDDLE EAST & NORTH AFRICA: PREDICTION MODELS FOR GROWTH FROM INDUSTRY TRANSITIONS ---  ###
...
```{r}
###  --- NORTH AMERICA: PREDICTION MODELS FOR GROWTH FROM INDUSTRY TRANSITIONS ---  ###
...
```{r}
###  --- SOUTH ASIA: PREDICTION MODELS FOR GROWTH FROM INDUSTRY TRANSITIONS ---  ###
...
```{r}
###  --- SUB SAHARAN AFRICA: PREDICTION MODELS FOR GROWTH FROM INDUSTRY TRANSITIONS ---  ###
