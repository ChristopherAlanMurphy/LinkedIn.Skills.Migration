...
ggplot(EAP_Largest_Average, aes(x=growth_rate_variance)) + 
  ...
  scale_x_continuous(breaks=-13:18) + geom_vline(xintercept = 0, linetype="dotted", color = "red", linewidth=1.5) + 
...
ggplot(EAP_Largest_Average, aes(x=industry_name,y=cumulative_growth_rate)) + 
  geom_boxplot(color="blue", fill="white") + geom_hline(yintercept = 0, linetype="dotted", color = "red", linewidth=1.5) + 
  scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + 
...
ggplot(ECA_Largest_Average, aes(x=growth_rate_variance)) + 
  geom_histogram(color="blue", fill="white", binwidth=5) + 
  scale_x_continuous(breaks=-13:24) + geom_vline(xintercept = 0, linetype="dotted", color = "red", linewidth=1.5) + 
...
ggplot(LAC_Largest_Average, aes(x=growth_rate_variance)) + 
  geom_histogram(color="blue", fill="white", binwidth=5) + 
  scale_x_continuous(breaks=-24:13)+ geom_vline(xintercept = 0, linetype="dotted", color = "red", linewidth=1.5)  + 
  scale_y_continuous(name="Count", limits=c(0, 60), breaks=seq(0,60,5)) + 
...
ggplot(MENA_Largest_Average, aes(x=growth_rate_variance)) + 
  geom_histogram(color="blue", fill="white", binwidth=5) + 
  scale_x_continuous(breaks=-20:30)+ geom_vline(xintercept = 0, linetype="dotted", color = "red", linewidth=1.5)  + 
  scale_y_continuous(name="Count", limits=c(0, 60), breaks=seq(0,60,5)) + 
...
ggplot(SA_Largest_Average, aes(x=growth_rate_variance)) + 
  geom_histogram(color="blue", fill="white", binwidth=5) + 
  scale_x_continuous(breaks=-20:20)+ geom_vline(xintercept = 0, linetype="dotted", color = "red", linewidth=1.5)  + 
